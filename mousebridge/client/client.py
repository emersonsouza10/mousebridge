"""Cliente MouseBridge: roda na máquina secundária (controlada remotamente).
...
from mousebridge.discovery import discover_server
from mousebridge.discovery.beacon import get_local_ip
from mousebridge.mouse import ScreenInfo, entry_position, get_virtual_screen, opposite_edge
from mousebridge.transport import Message, MessageStream, MsgType
from mousebridge.transport.security import build_client_ssl_context, sign_challenge
...
class MouseBridgeClient:
    ...
    async def run(self) -> None:
        from mousebridge.keyboard.injector import KeyboardInjector
        from mousebridge.mouse.injector import MouseInjector
